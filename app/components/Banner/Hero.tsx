...
export function Hero() {
  return (
    <div className="justify-center items-center text-center lg:mx-24">
       <Spotlight
        className="-top-40 left-0 md:left-60 md:-top-20 lg:flex sm:hidden"
        fill="blue"
      />
        <div className="mx-12 lg:mx-56 items-center">
        ...
        <div className="block sm:flex-row  gap-4 mt-6">
...
<span className="relative text-white text-md items-center lg:text-2xl font-semibold">Demander un devis</span>
</Link>
</button>
        </div>
    </div>
