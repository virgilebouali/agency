...
const Newsletter = () => {
    return (
        <div className=' relative z-3'>
            <div className="mx-auto max-w-2xl lg:max-w-7xl bg-midnightblue rounded-3xl">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 xl:gap-x-8">
                    ...
                    <div className="p-10 flex flex-col justify-center">
                        <h3 className="text-4xl md:text-5xl font-semibold mb-3 text-white">Demander à etre contacter</h3>
                        <h4 className="text-base font-normal mb-7 text-offwhite">Renseignez votre e-mail et nous vous contacterons dans les plus brefs délais</h4>
                        <div className="flex gap-0">
                            <input type="Email address" name="q" className="py-4 text-sm w-full text-black bg-white rounded-l-lg pl-4" placeholder="e-mail" autoComplete="off" />
