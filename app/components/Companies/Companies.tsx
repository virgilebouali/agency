...
const Companies = () => {
  return (
    <div>
<section> {/* Container */} <div className="mx-auto w-full max-w-7xl px-5 py-6 md:px-10 md:py-24 lg:py-32 -mt-96 -mb-16">

    <h5 className="mb-6 text-center text-4xl font-bold text-blue-500 md:mb-10 lg:mb-12">NOS CLIENTS 📈</h5>
