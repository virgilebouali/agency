...
const Companies = () => {
  return (
    <div>
<section> {/* Container */} <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32 -mt-96 -mb-16">
<Tooltip />

    <h5 className="mb-6 text-center text-4xl font-bold md:mb-10 lg:mb-12 leading-loose">Ils nous ont fait confiance pour leur <span className="bg-blue">développement digital.</span> </h5>
