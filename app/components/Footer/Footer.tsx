...
const products: ProductType[] = [
    {
        id: 1,
        link: ['Nos services', 'Nous', 'Études de cas', 'Projets'],
    },
    {
        id: 2,
        link: ['Nous contacter', 'Devis gratuit', 'Carrière', 'Team']
    }
]
        ...
        <div className="bg-darkblue -mt-40">
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        <div className="flex gap-2">
                            ...
                            <h5 className="text-base font-normal text-offwhite">Paris, France</h5>
                        </div>

                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/email.svg'} alt="email-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-offwhite">contact@crafters.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-offwhite text-sm text-center lg:text-start font-normal'>@2023 Crafters. Tous droits réservés </h4>
                    <div className="flex gap-5 mt-5 lg:mt-0 justify-center lg:justify-start">
                        <h4 className='text-offwhite text-sm font-normal'><Link href="/" target="_blank">Politique de confidentialité</Link></h4>
                        <div className="h-5 bg-bordertop w-0.5"></div>
                        <h4 className='text-offwhite text-sm font-normal'><Link href="/" target="_blank">Termes & conditions</Link></h4>
                    </div>
                </div>
